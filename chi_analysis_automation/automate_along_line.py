...
with open(path+write+'.csv','r') as csvfile:
  ...
  for row in csvReader:
     ...
     instanceSRTM.chiAnalysis(instanceSRTM,iterations = iterations,  min_basin = min_basin, interval_basin = basin_interval, print_litho_info=False, burn_raster_to_csv = burn_raster_to_csv)     
